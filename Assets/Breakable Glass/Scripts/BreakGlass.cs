...
public class BreakGlass : MonoBehaviour {
	...
	*/
	public void BreakIt(){
		...
		//BrokenGlassInstance = Instantiate(BrokenGlassGO[0], transform.position, transform.rotation) as GameObject;
		BrokenGlassInstance.transform.parent = transform.parent;
